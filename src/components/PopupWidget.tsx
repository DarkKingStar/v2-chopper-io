  ...
  return (
    <div>
      <Disclosure>
        {({ open }) => (
          <>
            <DisclosureButton className="fixed z-40 flex items-center justify-center transition duration-300 bg-theme-200 rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-theme-100 focus:bg-theme-100 ease">
            ...
            >
              <DisclosurePanel className=" flex flex-col  overflow-hidden left-0 h-full w-full sm:w-[350px] min-h-[250px] sm:h-[600px] border border-gray-300 dark:border-gray-800 bg-white shadow-2xl rounded-md sm:max-h-[calc(100vh-120px)]">
                <div className="flex flex-col items-center justify-center h-32 p-5 bg-theme-100">
                ...
                <div className="flex-grow h-full p-6 overflow-auto bg-gray-50 ">
                  {!isSubmitSuccessful && (
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                      ...
                      <input
                        type="hidden"
                        value={`${userName} sent a message from Chopper.IO`}
                        {...register("subject")}
                      />
                      <input
                        type="hidden"
                        value="Chopper.IO Template"
                        {...register("from_name")}
                      />
                      <input
                        type="checkbox"
                      ...
                      <div className="mb-3">
                        <button
                          type="submit"
                          className="w-full px-3 py-4 text-white bg-theme-200 rounded-md focus:bg-theme-100 focus:outline-none"
                        >
                          {isSubmitting ? (
                            <svg
                  ...
                  {isSubmitSuccessful && isSuccess && (
                    <div className="flex flex-col items-center justify-center h-full text-center text-white rounded-md">
                      ...
                      <button
                        className="mt-6 text-theme-100 focus:outline-none"
                        onClick={() => reset()}
                      >
                        Go back
                      </button>
